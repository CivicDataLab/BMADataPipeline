...
class CanalDredgingProgress(Base):
    ...
    total_canals_assigned              = Column(String(255))
    total_length_assigned_m            = Column(String(255))
    regularly_maintained_canals        = Column(String(255))
    regularly_maintained_length_m      = Column(String(255))
    periodically_flowed_canals         = Column(String(255))
    periodically_flowed_length_m       = Column(String(255))
    total_maintained_flowed_length_m   = Column(String(255))
    percent_maintained_flowed          = Column(Float)
    planned_dredging_canals            = Column(String(255))
    planned_dredging_length_m          = Column(String(255))
    annual_budgeted_canals             = Column(String(255))
    annual_budgeted_length_m           = Column(String(255))
    annual_budget                      = Column(String(255))
    annual_committed_budget            = Column(String(255))
    dredged_length_annual_budget_m     = Column(String(255))
    percent_dredged_annual_budget      = Column(Float)
    additional_budgeted_canals         = Column(String(255))
    additional_budgeted_length_m       = Column(String(255))
    supplementary_budget               = Column(String(255))
    supplementary_committed_budget     = Column(String(255))
    dredged_length_supplementary_budget_m = Column(String(255))
    percent_dredged_supplementary_budget   = Column(Float)
    total_dredged_canals               = Column(String(255))
    total_percent_dredged              = Column(Float)
    remarks                            = Column(String(255))
    district_code                      = Column(String(50))
    buddhist_year                      = Column(String(255))
